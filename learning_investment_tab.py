...
def render_stack_investment_tab(TECHNOLOGIES, get_stack_display_name, 
...
def render_bop_epc_investment_tab(get_region_display_name, bop_epc_costs_0, 
                                  regional_capacities_0, bop_epc_alphas, REGIONS):
    """Render the Balance of Plant & EPC Learning Investments tab"""
